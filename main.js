...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    ...
    const glasses = await loadGLTF('./models/glasses1/scene.gltf');
    ...
    const glasses2 = await loadGLTF('./models/glasses2/scene.gltf');
    ...
    const hat1 = await loadGLTF('./models/hat1/scene.gltf');
    ...
    const hat2 = await loadGLTF('./models/hat2/scene.gltf');
    ...
    const earringLeft = await loadGLTF('./models/earring/scene.gltf');
    ...
    const earringRight = await loadGLTF('./models/earring/scene.gltf');
